...
public class AnimationCode3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lines = System.IO.File.ReadLines("Assets/AnimationFileCrimePerson3.txt").ToList();
    ...
    void Update()
    {
        ...
        else
        {
            for (int i =0; i<=32;i++)
            {
                Body[i].transform.localPosition = new Vector3(-1000, -1000, -1000);
            }
        }
